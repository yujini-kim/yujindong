...
function Terms() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center px-4">
      <div className="bg-[#E3DBCE] border-2 w-full max-w-[600px] p-6 flex flex-col items-start rounded-md">
        {/* 서비스 이용약관 */}
        <h1 className="w-full bg-[#EFBE53] border-2 p-2 text-3xl font-bold mb-6 text-center">
          서비스 이용약관
        </h1>
        <p>
        ...
        {/* 개인정보처리방침 */}
        <h1 className="w-full bg-[#EFBE53] border-2 p-2 text-3xl font-bold mt-12 mb-6 text-center">
          개인정보처리방침
        </h1>
        <p className="mb-4">
